...
<div className="mb-16">
  ...
  {/* Card only wraps logos */}
  <div className="rounded-2xl border border-slate-200 bg-slate-50 px-8 py-8">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-10 items-center">
        {[
          ...
          >
            <img
              src={brand.src}
              alt={brand.name}
              className="h-7 w-auto object-contain grayscale opacity-60 hover:opacity-100 hover:grayscale-0 transition duration-300"
            />
          </div>
        ))}
      </div>
